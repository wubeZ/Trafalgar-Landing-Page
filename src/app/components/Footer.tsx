...
const Footer = () => {
  return (
    <div className="h-80 lg:h-96 grid grid-cols-1 lg:grid-cols-[5fr_2fr_2fr_2fr] text-white gap-10 p-8 lg:p-28 text-lg bg-gradient-to-bl from-[#67C3F3] to-[#5A98F2]">
      ...
      <ul className="hidden lg:block list-none font-extralight space-y-2">
