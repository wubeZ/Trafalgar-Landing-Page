...
const TestimonialCard = () => {
  return (
    <div className="flex flex-col lg:gap-6 items-center bg-gradient-to-r from-sky-500 to-sky-400 text-white py-8 lg:py-10 rounded-2xl lg:px-20 w-full">
      ...
      <div className="flex flex-col px-2 lg:flex-row items-center lg:justify-center lg:items-start gap-2 lg:gap-8 mt-4 lg:mt-8 w-full ">
        ...
        <p className="font-light lg:pl-24 text-sm lg:text-xl text-left mx-8 md:mx-44 lg:mx-0">
